...
@patch("backend.batch.utilities.helpers.AzureSearchHelper.SearchClient")
@patch("backend.batch.utilities.helpers.AzureSearchHelper.SearchIndexClient")
def test_creates_search_index_if_it_does_not_exist(
    search_index_client_mock: MagicMock,
    search_client_mock: MagicMock,
):
    # given
    search_index_client_mock.list_index_names.return_value = ["some-irrelevant-index"]
    ...
    fields = [
        ...
        SearchField(
            ...
            searchable=True,
            vector_search_dimensions=[0] * 1536,
    ...
    # then
    search_index_client_mock.return_value.create_index.assert_called_once_with(index)
